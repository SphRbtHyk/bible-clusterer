...
RUN python3 -m pip install -r gnt_core/requirements.txt && \
    python3 -m pip install -e ./gnt_core --use-feature=in-tree-build && \
    python3 -m pip install -r gnt_nlp_utils/requirements.txt && \
    python3 -m pip install -e ./gnt_nlp_utils --use-feature=in-tree-build && \
    python3 -m pip install -r gnt_api/external-requirements.txt && \
    python3 -m pip install -e ./gnt_api --use-feature=in-tree-build
